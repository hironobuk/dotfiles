...
curl -s https://raw.githubusercontent.com/hironobuk/dotfiles/main/.bashrc >> "${HOME}/.bashrc"

for file in .bash_profile .vimrc .gitconfig .screenrc .tmux.conf; do
  curl -s -o "${HOME}/${file}" https://raw.githubusercontent.com/hironobuk/dotfiles/main/${file}
done
...
curl -s -o "${HOME}/.vim/after/syntax/html.vim" https://raw.githubusercontent.com/hironobuk/dotfiles/main/.vim/ng-template.vim
curl -s -o "${HOME}/.config/nvim/after/syntax/html.vim" https://raw.githubusercontent.com/hironobuk/dotfiles/main/.vim/ng-template.vim
...
for file in init.vim options.rc.vim keymap.rc.vim dein.toml deinlazy.toml plugins/deoplete.rc.vim plugins/molokai.rc.vim plugins/airline.rc.vim plugins/neoterm.rc.vim; do
  curl -s -o "${HOME}/.config/nvim/${file}" https://raw.githubusercontent.com/hironobuk/dotfiles/main/.config/nvim/${file}
done
